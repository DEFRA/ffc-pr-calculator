...
describe('calculate', () => {
  ...
  test('1000 includes all scheme years', () => {
    ...
    expect(result.bandResult[0].result.length).toBe(3)
  })
  ...
  test('40000 calculates 2021 reduction', () => {
    ...
    expect(result.bandResult[0].result.length).toBe(3)
    expect(result.bandResult[1].result.length).toBe(3)
  })
  ...
  test('75000 calculates 2021 reduction', () => {
    ...
    expect(result.bandResult[0].result.length).toBe(3)
    expect(result.bandResult[1].result.length).toBe(3)
    expect(result.bandResult[2].result.length).toBe(3)
  })
  ...
  test('250000 calculates 2021 reduction', () => {
    ...
    expect(result.bandResult[1].result.length).toBe(3)
    expect(result.bandResult[2].result.length).toBe(3)
    expect(result.bandResult[3].result.length).toBe(3)
  })
  ...
  test('overall result 1000 = result + reduction for 2021', () => {
    ...
    expect(overallResult.payment + overallResult.reduction).toBe(overallResult.value)

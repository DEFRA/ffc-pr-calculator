...
Scenario: 002-User can click on licence link
Given I open the url "/"
...
Scenario: 005-User can click on Calculate my progressive reductions link
Given I open the url "/"
When I click on start new calculator button ".govuk-button--start"
Then I expect that the url contains "/value"
...
Scenario: 006-User can click on Accessibility statement link
Given I open the url "/"
When I click on start new calculator button ".govuk-button--start"
Then I expect that the url contains "/value"
...
Scenario: 007-User can click licence link on value page
Given I open the url "/value"
When I click on the link "Open Government Licence v3.0"
Then I expect that element "#license > main > h1" contains the text "Open Government Licence for public sector information"   

Scenario: 008-User can click copyright link on value page
Given I open the url "/value"
When I click on the link "© Crown copyright"
Then I expect that element "h1" contains the text "Crown copyright"

Scenario: 009-User can click gov link on value page
Given I open the url "/value"
When I click on the link "GOV.UK"
Then I expect that element "h1" contains the text "Welcome to GOV.UK"

Scenario: 010-User can click progressive reduction  link on value page
Given I open the url "/value"
When I click on the link "Calculate my progressive reductions"
Then I expect that element "h1" contains the text "Check how your BPS payments will reduce until 2024"

Scenario: 011-User can click accessibility statement link on value page
Given I open the url "/value"
When I click on the link "Accessibility statement"
Then I expect that element "h1" contains the text "Accessibility statement"

Scenario: 012-User can click cookies link on value page
Given I open the url "/value"
...
Scenario: 013-Can navigate back to previous page
Given I open the url "/"
When I click on start new calculator button ".govuk-button--start"
...
Scenario: 014-User can click licence link on calculation page
Given I open the url "/calculation?value=32"
When I click on the link "Open Government Licence v3.0"
Then I expect that element "#license > main > h1" contains the text "Open Government Licence for public sector information"

Scenario: 015-User can click copyright link on calculation page
Given I open the url "/calculation?value=32"
When I click on the link "© Crown copyright"
Then I expect that element "h1" contains the text "Crown copyright"

Scenario: 016-User can click gov link on calculation page
Given I open the url "/calculation?value=32"
When I click on the link "GOV.UK"
Then I expect that element "h1" contains the text "Welcome to GOV.UK"

Scenario: 017-User can click progressive reduction  link on calculation page
Given I open the url "/calculation?value=32"
When I click on the link "Calculate my progressive reductions"
Then I expect that element "h1" contains the text "Check how your BPS payments will reduce until 2024"

Scenario: 018-User can click accessibility statement link on calculation page
Given I open the url "/calculation?value=32"
When I click on the link "Accessibility statement"
Then I expect that element "h1" contains the text "Accessibility statement"

Scenario: 019-User can click cookies link on calculation page
Given I open the url "/calculation?value=32"
When I click on the link "Cookies"
Then I expect that element "main > h2" contains the text "Details about cookies on Calculate my progressive reductions"

describe('value-calculator route', () => {
  let createServer
  let server
  ...
  test('GET /value-calculator returns 200', async () => {
    const options = {
      method: 'GET',
  ...
  test('GET /value-calculator returns value-calculator view', async () => {
    const options = {
      method: 'GET',
      url: '/value-calculator'
    }
  ...
  test('GET /value-calculator context includes Header', async () => {
    const options = {
      method: 'GET',
      url: '/value-calculator'
    }
  ...
  test('POST /value-calculator returns 302', async () => {
    const options = {
      method: 'POST',
      url: '/value-calculator',
  ...
  test('POST /value-calculator invalid', async () => {
    const options = {
      method: 'POST',
      url: '/value-calculator',
  ...
  test('POST /value-calculator redirects to calculation', async () => {
    const value = 1000.01
  ...
  test('POST /value-calculator above £1,000,000,000.', async () => {
    const options = {
      method: 'POST',
      url: '/value-calculator',
  ...
  test('POST /value-calculator not a number', async () => {
    const options = {
      method: 'POST',
      url: '/value-calculator',
      payload: { value: 'abc' }
  ...
  test('POST /value-calculator too high to be number', async () => {
    const options = {
      method: 'POST',
      url: '/value-calculator',
  ...
  test('GET /value-calculator layout includes use the Enter your BPS starting payment amount header', async () => {
    const options = {
      method: 'GET',
      url: '/value-calculator'
    }
  ...
  test('GET /value-calculator first paragraph says This calculator will estimate your payment for the 2023 scheme year based on the starting payment amount you enter.', async () => {
    const options = {
      method: 'GET',
      url: '/value-calculator'
    }
  ...
  test('GET /value-calculator second paragraph says You will also see estimated payments for the 2021 and 2022 scheme years when you input your starting amount.', async () => {
    const options = {
      method: 'GET',
      url: '/value-calculator'
    }
